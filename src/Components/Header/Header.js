        ...
        <StyledToolbar>
          <Box sx={{flexGrow: 1, display: 'flex', alignItems: 'center'}}>
            ...
            <Typography
                ...
                noWrap
                component="div"
                sx={{ color:"#49516F", fontWeight:"bolder",fontSize: '2.5rem' }}
            >
              Weddingly
            </Typography>
            <NavLinkItem to={''} text={"Login"}/>
            <NavLinkItem to={'register'} text={"Register"}/>
          </Box>
            <Button variant="nav-button">Log In</Button>
